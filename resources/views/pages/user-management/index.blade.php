                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                      <img style="object-fit: cover" src="@if($user->photo) {{ asset($user->photo) }} @else {{ asset('assets/img/default-user-image.png') }} @endif" class="avatar avatar-sm me-3" alt="user1">
                                                    </div>
